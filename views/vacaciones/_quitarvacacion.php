    ...
    <?php
          echo $form->label($model, 'fechadesde',array('label'=>'Fecha'));
             echo $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                    ...
                    'htmlOptions' => array(
                       'style' => 'width: 155px;',
                        'onchange'=>'Vacaciones.mostrarOpcionquitar()'
...
<div class="column">
		...
		<?php
            ...
            echo $form->numberField($model,'dias',array('step'=> '0.5','value'=>'0.5',  'style' => 'width: 55px;','onchange'=>'Vacaciones.mostrarOpcionquitar()'));
      ...
      <div class="column">
		...
		<?php echo $form->dropDownList($model,'jornada',CHtml::listData(array(array('id'=>'','nombre'=>''),array('id'=>'1','nombre'=>'Al Inicio de la Jornada'),array('id'=>'2','nombre'=>'Al Finalizar la Jornada')),'id','nombre'),array('onchange'=>'Vacaciones.mostrarOpcionquitar()')); ?>
	    </div>
</div>
        <div class="row">
            <div class="column">
		<?php echo $form->labelEx($model,'tipo',array('label'=>'Seleccion..')); ?>
		<?php echo $form->dropDownList($model,'tipo',CHtml::listData(array(array('id'=>'','nombre'=>''),array('id'=>'2','nombre'=>'Mujeres'),array('id'=>'3','nombre'=>'Varones'),array('id'=>'4','nombre'=>'Todos')),'id','nombre'),array('onchange'=>'Vacaciones.mostrarOpcionquitar()')); ?>
	</div>
            <div class="column">
