...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="formWindow">   
	 <div class="row">
        ...
        <div class="row">
            ...
            <?php
             $lista = Tipo::model()->findAll('t.idcategoriatipo in(select id from general.categoriatipo where eliminado=false and enkardex=true)');
       
           $this->widget('ext.select2.ESelect2', array(
                'id' => 'beneficio',
                'name' => 'beneficio',
                'value' => $lista,
                'data' =>  CHtml::listData(Tipo::model()->findAll('t.idcategoriatipo in(select id from general.categoriatipo where eliminado=false and enkardex=true)'), 'id', 'nombre')
       ,
                'htmlOptions' => array(
                    'multiple' => 'multiple',
                    'style' => 'width:100%;'
    ...
    echo System::Buttons(array(
        'nameView' => 'Empleado',
        'buttons' => array( 'kardex' => array(
                'label' => 'Imprimir',
                'click' => 'Empleado.descargaReportekardexempleado()',
                'icon' => 'print',
                'width' => 130,))
    ));
    ?> 
