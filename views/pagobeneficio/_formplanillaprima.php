...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        <div class="column">
            ...
            <?php echo $form->labelEx($model,'opciones',array('label'=>'Seleccione...')); ?>
            <?php echo $form->dropDownList($model,'opciones',CHtml::listData(array(array('id'=>0,'nombre'=>''),array('id'=>1,'nombre'=>'Personal Retirado'),array('id'=>2,'nombre'=>'Personal No Retirado'),array('id'=>3,'nombre'=>'Todos'), ),'id','nombre')); ?> 
   ...
   echo System::Buttons(array(
        ...
        'buttons' => array(
                        ...
                        'planillas' => array(
                            ...
                            'click' => 'Pagobeneficio.descargarExcelPlanillaPrima()',
                            'icon' => 'download-alt',
                            'width' => 130,)
            )
    ));
