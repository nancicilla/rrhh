...
<div class="row">
	...
	<div class="row">
		<?php echo $form->label($model,'numpago'); ?>
		<?php echo $form->textField($model,'numpago'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'fechasolicitud'); ?>
                ...
                'name' => 'pagobeneficio[fechasolicitud]',
                ...
                'options' => array(
                    ...
                    'dateFormat' => 'dd-mm-yy',
                    'maxDate' => 'today',
                    'onClose' => 'js:function(selectedDate) {admPagobeneficio.search()}'
