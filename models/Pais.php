 ...
 * This is the model class for table "general.pais".
 *
 * The followings are the available columns in table 'general.pais':
 * @property integer $id
...
class Pais extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('id, codigo, nombre, usuario, fecha, eliminado', 'safe', 'on'=>'search'),
            );
    }
    ...
    public function relations()
    {
            ...
            return array(
                    'departamentos' => array(self::HAS_MANY, 'Departamento', 'idpais'),
            );
    }
