...
class TipocontratoController extends Controller
{
        ...
        if(isset($_POST['Tipocontrato'])){
               ...
               if($model->save()){   
                ...
                if (isset($_POST['aportacion'])) {
                    $aporaciones=$_POST['aportacion'];
                }
                Tipocontrato::model()->registrarBeneficioAportes($model->id,$beneficios,$aporaciones);
    ...
    public function actionUpdate($id)
    {
        ...
        $listabeneficio= Tipocontrato::model()->listaTipoBeneficio($model->id);
        $listaaportacion=Tipocontrato::model()->listaApotaciones($model->id);
        ...
        if(isset($_POST['Tipocontrato']))
        {
            ...
            if($model->save()){
                ...
                Tipocontrato::model()->actualizarBeneficioAportes($model->id, $beneficios,$aporaciones);
