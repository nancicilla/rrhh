 ...
 <?php
                ...
                echo $form->dropDownList($model,'idhorario',CHtml::listData( Horario::model()->findAll() ,'id','nombre'),array('empty'=>'','onchange'=>'Movimientopersonal.dameInformacionHorario(this.value)'));
