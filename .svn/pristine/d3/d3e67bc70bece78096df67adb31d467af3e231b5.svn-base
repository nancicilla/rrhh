...
<div class="row" >
 ...
 <div class="column">
    ...
    echo $form->labelEx($historialContrato,'idpuestotrabajo',array('label'=>'Puesto de Trabajo')); ?>
    <div  id="conta">
        
        <?php 
             
        echo $form->dropDownList($historialContrato,'idpuestotrabajo',CHtml::listData($puestotrabajos,'id','nombre'),array('empty'=>'','data-v'=>'','disabled'=>($model->scenario=='update' && $modificar==0)?true:false));?>
    </div>
    </div>
    </div>
    <div class="row">
    ...
    <div class="column" style="width: 50%;">
        ...
        if($model->scenario=='update' && $modificar==0){
            echo "".$historialContrato->nivelsalarial;
