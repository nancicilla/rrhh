 ...
 * This is the model class for table "general.departamento".
 *
 * The followings are the available columns in table 'general.departamento':
 * @property integer $id
...
class Departamento extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    array('idpais, prioridad', 'numerical', 'integerOnly'=>true),
                    array('nombre', 'length', 'max'=>50),
                    array('usuario', 'length', 'max'=>30),
                    array('fecha, eliminado', 'safe'),
                    // The following rule is used by search().
                    // @todo Please remove those attributes that should not be searched.
                    array('id, nombre, idpais, prioridad, usuario, fecha, eliminado', 'safe', 'on'=>'search'),
            );
    }
